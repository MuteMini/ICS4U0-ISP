...
/**
 * World Five in tutorial, subclass of world with specified values
 * 
 ...
 * @author Min, Ishan
 */
public class TutorialFive extends World {
	
	/**
	 * Creates TutorialFive, with the specified boundary values
	 * @author Min
	 * @since June 12th
	 */
	public TutorialFive() {
		super(-667, -6000, 0, 10000, 10000, 10000);
