...
/**
 * World Two in tutorial, subclass of world with specified values
 * 
 ...
 * @author Min, Ishan
 */
public class TutorialTwo extends World {
	
	/**
	 * Creates TutorialTwo, with the specified boundary values
	 * @author Min
	 * @since June 12th
	 */
	public TutorialTwo() {
		super(-667, -9108, 0, 10000, 10000, 10000);
